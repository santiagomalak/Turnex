...
import { RegistroSocioForm } from './registro-form'
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 mt-1 text-sm">Registro de socio</p>
        </div>
        ...
        <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-4">
          ¿Ya tenés cuenta?{' '}
          <Link href="/portal/login" className="text-zinc-900 dark:text-white font-medium hover:underline">
            Iniciá sesión
          </Link>
        </p>
      </div>
