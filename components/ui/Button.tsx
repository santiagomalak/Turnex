...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'primary', size = 'md', loading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-zinc-900 text-white hover:bg-zinc-700 focus:ring-zinc-900 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200',
      ...
      ghost: 'bg-transparent hover:bg-zinc-100 focus:ring-zinc-400 dark:hover:bg-zinc-800',
